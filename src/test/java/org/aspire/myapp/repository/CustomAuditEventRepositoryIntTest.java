package org.aspire.myapp.repository;

import org.aspire.myapp.MyApp;
import org.aspire.myapp.config.Constants;
import org.aspire.myapp.config.audit.AuditEventConverter;
import org.aspire.myapp.domain.PersistentAuditEvent;
...
import static org.aspire.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
